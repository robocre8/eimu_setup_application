...
class YawVelDriftComputeFrame(tb.Frame):
  def __init__(self, parentFrame):
    ...
    self.label = tb.Label(self, text="YAW VEL BIAS COMPUTE", font=('Monospace',16, 'bold') ,bootstyle="dark")
  ...
  def reset_all_params(self):
    ...
    self.yaw0 = g.eimu.readYawWithDrift()
    self.t0 = time_ns()
  ...
  def print_data(self):
    ...
    g.eimu.writeYawVelDriftBias(yawVelDriftBias)

    yawVelDriftBias = g.eimu.readYawVelDriftBias()
