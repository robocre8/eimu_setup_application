...
from eimu.pages.SerialConnectPage import SerialConnectFrame
from eimu.pages.MainAppPage import MainAppFrame
...
def main():
  g.app = App(title="EASY IMU SETUP APPLICATION", size=(900,650))
  g.app.mainloop()
